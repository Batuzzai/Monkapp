En el area de back end de la app se utiliza MySql como base de datos para almacenar los datos de los usuarios registrados, PHP como lenguaje de procesamiento de datos recibidos desde la app.
